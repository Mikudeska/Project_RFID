...
async function exportSeatMap() {
    try {
        ...
        const response = await axios.get(`${API_BASE}export-seat-map/`, {
            params: params,
            responseType: 'blob',
...
onMounted(async () => {
    ...
    loading.value = true;
    try {
        console.log('📡 กำลังโหลดข้อมูลจาก API:', `${API_BASE}person/`);
...
<template>
    <div>
        ...
        <div class="fixed z-50 top-20 right-6 flex flex-row gap-3">
            <!-- Designer Button -->
            <button
                v-if="auth.status !== 'Staff'"
                @click="$router.push('/uikit/SeatDesigner')"
                class="p-2 transition-all duration-300 bg-purple-100 dark:bg-purple-900 border border-purple-300 dark:border-purple-600 rounded-full shadow-lg hover:bg-purple-200 dark:hover:bg-purple-800 hover:scale-110 hover:shadow-xl transform"
                title="ออกแบบแผนที่นั่ง"
            >
            ...
            <button
                @click="exportSeatMap"
                class="p-2 transition-all duration-300 bg-green-100 dark:bg-green-900 border border-green-300 dark:border-green-600 rounded-full shadow-lg hover:bg-green-200 dark:hover:bg-green-800 hover:scale-110 hover:shadow-xl transform"
                title="โหลดแผนที่นั่งเป็น Excel"
            >
            ...
            <div
                ...
                class="absolute right-0 mt-16 z-50 bg-white/90 dark:bg-gray-800/90 rounded-xl shadow-xl p-4 w-96 sm:w-[800px] max-w-[95vw] flex flex-col sm:flex-row gap-3 border border-blue-100 dark:border-gray-600 animate-slide-in"
            >
                ...
                <div class="flex-1 order-2 sm:order-1">
                    ...
                    <div class="p-3 bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-gray-700 dark:to-gray-600 rounded-xl border border-blue-200 dark:border-gray-500">
                        ...
                        <div class="grid grid-cols-2 gap-2 mb-3">
                            ...
                            <!-- Reported - Full Width -->
                            <div class="col-span-2 text-center p-2 bg-white/80 dark:bg-gray-700/80 rounded-lg border border-green-200 dark:border-green-700 transform transition-all duration-300 hover:scale-105 hover:shadow-md">
