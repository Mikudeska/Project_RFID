...
const filteredPersons = computed(() => {
    ...
    return persons.value.sort((a, b) => {
        ...
        // 2. ถ้าปริญญาเดียวกัน ให้เรียงตาม id
                    ...
                    <div class="flex items-center min-w-0 gap-3 px-2 py-1 border-b border-blue-100 dark:border-gray-600">
                        ...
                        <div class="relative w-full">
                            ...
                            <div v-if="!searchQuery" class="absolute left-3 top-1/2 -translate-y-1/2 pointer-events-none w-[calc(100%-2.5rem)] overflow-hidden">
                                <span class="block text-sm text-gray-400 dark:text-gray-200 animate-marquee whitespace-nowrap"> ค้นหาเลขนิสิต 4 ตัวท้าย, เลขที่นั่ง หรือ เลขที่บัณฑิต... </span>
                            </div>
                        </div>
