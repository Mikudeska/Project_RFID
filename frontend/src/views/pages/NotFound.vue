...
<template>
    ...
    <div class="flex items-center justify-center min-h-screen overflow-hidden">
        <div class="flex flex-col items-center justify-center">
            <svg width="54" height="40" viewBox="0 0 54 40" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-32 mb-8 shrink-0">
                <path
                    fill-rule="evenodd"
                    clip-rule="evenodd"
            ...
            <div style="border-radius: 56px; padding: 0.3rem; background: linear-gradient(180deg, color-mix(in srgb, var(--primary-color), transparent 60%) 10%, var(--surface-ground) 30%)">
                <div class="flex flex-col items-center w-full px-8 py-20 bg-surface-0 dark:bg-surface-900 sm:px-20" style="border-radius: 53px">
                    <span class="text-3xl font-bold text-primary">404</span>
                    <h1 class="mb-2 text-3xl font-bold text-surface-900 dark:text-surface-0 lg:text-5xl">Not Found</h1>
                    <div class="mb-8 text-surface-600 dark:text-surface-200">Requested resource is not available.</div>
                    <router-link to="/" class="flex items-center w-full py-8 border-b border-surface-300 dark:border-surface-500">
                        <span class="flex items-center justify-center border-2 border-primary text-primary rounded-border" style="height: 3.5rem; width: 3.5rem">
                            <i class="pi pi-fw pi-table !text-2xl"></i>
                        </span>
                        <span class="flex flex-col ml-6">
                            <span class="block mb-0 font-medium text-surface-900 dark:text-surface-0 lg:text-xl">Frequently Asked Questions</span>
                    ...
                    <router-link to="/" class="flex items-center w-full py-8 border-b border-surface-300 dark:border-surface-500">
                        ...
                        <span class="flex flex-col ml-6">
                            <span class="mb-0 font-medium text-surface-900 dark:text-surface-0 lg:text-xl">Solution Center</span>
                            <span class="text-surface-600 dark:text-surface-200 lg:text-xl">Phasellus faucibus scelerisque eleifend.</span>
                        </span>
                    </router-link>
                    <router-link to="/" class="flex items-center w-full py-8 mb-8 border-b border-surface-300 dark:border-surface-500">
                        <span class="flex items-center justify-center border-2 border-primary text-primary rounded-border" style="height: 3.5rem; width: 3.5rem">
                            <i class="pi pi-fw pi-unlock !text-2xl"></i>
                        </span>
                        <span class="flex flex-col ml-6">
                            <span class="mb-0 font-medium text-surface-900 dark:text-surface-0 lg:text-xl">Permission Manager</span>
